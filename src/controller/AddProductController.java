...
public class AddProductController implements Initializable {
    ...
    /**
     * Initiates AddProductController and provides table with products in inventory system.
     *
     * @param url
     * @param resources
     */
     ...
     *
     * @param alertCase Displays one of six different alerts for AddProductController
     */
     ...
     *
     * */
    @FXML void cancelProductButtonMethod(ActionEvent event) throws IOException {
     ...
     */
    @FXML void removeAssociatedPartButtonMethod(ActionEvent event) {
     ...
     */
    @FXML void partSearchButtonMethod(ActionEvent event) {
     ...
     * @param event Pressing key while part search button is clicked
     */
    @FXML void partSearchButtonKeyPressed(KeyEvent event) {
